...
combustibles, noticias locales/nacionales y frases/datos del Maule.
"""
...
def renderizar_plantilla_html(ahora, fecha_reporte, es_manana, eco, feriado, luna, extra, datos_clima, datos_noticias, datos_combustible):
...
async def main_async():
    ...
    # 5. Renderizado PNG e Imagen
    print("🎨 Generando HTML y renderizando PNG con Playwright...")
    html_final = renderizar_plantilla_html(ahora, fecha_reporte, es_manana, eco, feriado, luna, extra, datos_clima, datos_noticias, datos_combustible)
    imagen_bytes = await html_a_imagen(html_final)

    # 6. Crear texto del mensaje (Caption de 3 líneas exactas)
